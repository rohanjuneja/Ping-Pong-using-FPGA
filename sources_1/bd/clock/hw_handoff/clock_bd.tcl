...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set clk100M [ create_bd_port -dir I -type clk clk100M ]
  set_property -dict [ list \
CONFIG.FREQ_HZ {100000000} \
 ] $clk100M
  set clk65M [ create_bd_port -dir O -type clk clk65M ]
...
CONFIG.MMCM_DIVCLK_DIVIDE {5} \
  ...
  connect_bd_net -net clk100M_1 [get_bd_ports clk100M] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports clk65M] [get_bd_pins clk_wiz_0/clk_out1]
